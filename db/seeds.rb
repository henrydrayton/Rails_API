...
if User.count == 0 
    User.create(username: "Henry", email:"henry@test.com", password: "password1", password_confirmation: "password1")
    User.create(username: "Henry2", email:"henry2@test.com", password: "password2", password_confirmation: "password2")
end
